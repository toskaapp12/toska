...
4. **Age rating:** the app is 17+ (Frequent/Intense Mature/Suggestive Themes per the current rating). The age gate, Terms §2, and this rating must move together if the owner ever changes the age floor.
