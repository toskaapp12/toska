...
> Changelog
> - v1.0 (2026-07-17): First versioned release. Supersedes the undated web terms of June 16, 2026. Substantive changes from that text: honest description of post expiration mechanics (§8), narrowed and clarified content license (§7), explicit letters-about-real-people rule (§5), accurate backup-retention window (§12), version-tracked acceptance (§15).

Welcome to toska. By creating an account or using the app, you agree to these terms. If you don't agree, please don't use toska.
...
- interfere with the service, probe its security, or access data you're not authorized to access.

Automated systems screen content at posting time and may hold content for human review before or after it appears. Human moderators make final calls.
...
You own what you write. So we can run the app, you grant us a non-exclusive, worldwide, royalty-free license to **host, store, display, reproduce, and distribute your content within the toska service** — including showing it in feeds, threads, search, and notifications.
...
You can delete your account any time in Settings. Deletion removes your profile, posts, replies, likes, saves, drafts, notifications, and personal data through an automated cascade that begins immediately (see the Privacy Policy for exact scope and the backup window). Deletion is permanent.

## 11. Availability; changes to the service

toska is run by a very small team. We do our best, but the service is provided **"as is" and "as available"**, without warranties of any kind, express or implied, including merchantability, fitness for a particular purpose, and non-infringement. We may change, suspend, or discontinue any part of the service at any time.
...
You get toska through the Apple App Store, and Apple's Standard Licensed Application End User License Agreement also applies to your license of the app. Apple is not responsible for the app or its content, has no obligation to provide support, and is a third-party beneficiary of these terms with the right to enforce them.
