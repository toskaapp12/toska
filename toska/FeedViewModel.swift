...
class FeedViewModel: ObservableObject {
    ...
    static let dailyPrompts: [(String, String, String)] = [
            ("it's 2am and you can't sleep. what are you thinking about.", "longing", "moon.stars"),
            ...
            ("i don't want to start over with someone new and explain all my shit again. do you feel that.", "moving on", "arrow.right.circle"),
            ...
            ("what's the thing you can't tell anyone because they'd say you're crazy", "longing", "moon.stars"),
            ("write the letter you'll never send. start with dear you.", "unsent", "envelope"),
            ("what's something small that still ruins you. a song. a street. a food.", "regret", "arrow.uturn.backward"),
            ("do you miss them or do you miss not being alone. it's okay if you don't know.", "confusion", "questionmark.circle"),
            ("say the thing you pretend you don't feel anymore", "still love you", "heart"),
            ("what would it take to feel like a beginning instead of an aftermath.", "moving on", "arrow.right.circle"),
            ("what's the thing you can't forgive them for", "anger", "flame"),
            ...
            ("say something you haven't said out loud to anyone. not even yourself.", "unsent", "envelope"),
            ...
            ("you got out of bed today. that's not nothing. say it like it counts.", "acceptance", "leaf"),
            ("what song do you skip now because it ruins you", "longing", "moon.stars"),
            ("type out the message that's been sitting in your drafts for weeks", "unsent", "envelope"),
            ("what's the most pathetic thing you've done since it ended. no judgment here.", "regret", "arrow.uturn.backward"),
            ("the thing nobody understands about what happened is", "confusion", "questionmark.circle"),
            ("do you still love them. you don't have to answer that. but do you.", "still love you", "heart"),
            ("who are you when you're not orbiting them. be honest.", "moving on", "arrow.right.circle"),
            ("say it. the one thing you would've screamed if you weren't so busy being calm and reasonable", "anger", "flame"),
            ("what is the first thing that tasted good again. even a little.", "acceptance", "leaf"),
            ("what's the thought you have every single morning before you can stop it", "longing", "moon.stars"),
            ("write what you would've said if you'd picked up the last time they called", "unsent", "envelope"),
            ("what's the last thing that made you cry about it. like actually cry.", "regret", "arrow.uturn.backward"),
            ...
            ("i don't want to be brave. i just want to wake up and not reach for my phone first.", "moving on", "arrow.right.circle"),
            ("what's the lie they told that still makes your face hot when you remember it", "anger", "flame"),
            ("name one small thing you did today that you didn't think you'd manage.", "acceptance", "leaf"),
            ...
            ("what's the thing you wish you'd said before they walked out the door", "regret", "arrow.uturn.backward"),
            ...
            ("you're still here. say what got you through the worst hour.", "acceptance", "leaf"),
            ("finish this: i just want someone to", "longing", "moon.stars"),
            ("finish this: i never told you that", "unsent", "envelope"),
            ("there's a text you never sent. what's in it", "regret", "arrow.uturn.backward"),
            ("some days i'm fine and i can't tell if that's progress or if i just stopped feeling it.", "confusion", "questionmark.circle"),
            ("you tell people you're over it. who are you actually trying to convince.", "still love you", "heart"),
            ...
            ("i keep waiting to understand what went wrong like it's a sentence i'll finish someday.", "confusion", "questionmark.circle"),
            ("there's a version of you still waiting by the phone. say hi to her.", "still love you", "heart"),
            ("there was a whole life you planned around them. what gets to be yours now.", "moving on", "arrow.right.circle"),
            ("name the thing you forgave that you shouldn't have", "anger", "flame"),
            ("did you go outside today. even to the door. that's allowed to count.", "acceptance", "leaf"),
            ...
            ("what's the apology you keep rehearsing for no one", "regret", "arrow.uturn.backward"),
            ("you're not sad today. is that healing or is that just monday.", "confusion", "questionmark.circle"),
            ("if love really left. why does their name still do that to your chest.", "still love you", "heart"),
            ("i caught myself laughing today and didn't feel guilty after. is that what this is.", "moving on", "arrow.right.circle"),
            ("you're allowed to be furious. you don't have to be the bigger person tonight", "anger", "flame"),
            ("what felt almost normal today. don't rush past it.", "acceptance", "leaf"),
            ...
            ("what would you do this week if you weren't waiting for them to come back.", "moving on", "arrow.right.circle"),
            ("what did they take that they didn't even want. they just didn't want you to have it", "anger", "flame"),
            ("you've been holding it together for everyone. who holds it for you.", "acceptance", "leaf"),
            ...
            ("the apology you got was for the wrong thing wasn't it. what did they actually need to say", "anger", "flame"),
            ("what did you let yourself feel today instead of pushing it down.", "acceptance", "leaf"),
            ("what's the smell that brings them back instantly. cologne. their pillow. rain.", "longing", "moon.stars"),
            ("write what you wish you'd answered when they asked if you were okay", "unsent", "envelope"),
            ("what's the last thing you lied to them about. and why", "regret", "arrow.uturn.backward"),
            ("i replay the part where it was still good and i can't find the exact second it wasn't.", "confusion", "questionmark.circle"),
            ("you've forgiven them already haven't you. you just haven't told them.", "still love you", "heart"),
            ("what is one thing that's yours again that used to be ours.", "moving on", "arrow.right.circle"),
            ...
            ("there's a version of you that fought harder. what would they have done", "regret", "arrow.uturn.backward"),
            ("are you over it or did you just run out of ways to say you're not.", "confusion", "questionmark.circle"),
            ("if they called and only said your name. what would you do.", "still love you", "heart"),
            ("i don't want a clean slate. i just want to stop flinching at their name.", "moving on", "arrow.right.circle"),
            ("what's the sentence of theirs you replay just to stay angry enough not to text back", "anger", "flame"),
            ("what part of your day didn't hurt. start there.", "acceptance", "leaf"),
            ("what part of their body do you miss the most. not the obvious one.", "longing", "moon.stars"),
            ("type the message you'll never have the nerve to send", "unsent", "envelope"),
            ("what do you reread late at night that you know you shouldn't", "regret", "arrow.uturn.backward"),
            ...
            ("what did you want to say at the door but didn't", "unsent", "envelope"),
            ("what did you take for granted right up until it was gone", "regret", "arrow.uturn.backward"),
            ("i'm not crying anymore and i don't know if that's relief or something worse.", "confusion", "questionmark.circle"),
            ...
            ("what are you still pretending you don't miss.", "acceptance", "leaf"),
            ("do you still know their number by heart. do you ever almost dial it.", "longing", "moon.stars"),
            ("write the version of i love you you couldn't say back then", "unsent", "envelope"),
            ("finish this: if i'd only", "regret", "arrow.uturn.backward"),
            ...
            ("what would you say to their face if you knew they'd actually have to sit there and hear it", "anger", "flame"),
            ("did you laugh today. even once. it doesn't mean you're okay but it's something.", "acceptance", "leaf"),
            ...
            ("what's the thing they asked you for that you didn't give them", "regret", "arrow.uturn.backward"),
            ("there's a version of me from before that i can't get back to. do you ever look for yours.", "confusion", "questionmark.circle"),
            ("if they were happy without you. could you actually be glad. could you.", "still love you", "heart"),
            ("you're allowed to want a future that doesn't include them. say it out loud.", "moving on", "arrow.right.circle"),
            ("they're out there telling their side. what's the part they're leaving out", "anger", "flame"),
            ("what would it look like to be gentle with yourself for the next ten minutes.", "acceptance", "leaf"),
            ("i keep their side of the bed cold and untouched like they're coming back.", "longing", "moon.stars"),
            ...
            ("i thought i knew them. now i don't know which year was the lie.", "confusion", "questionmark.circle"),
            ("you stopped texting them. you didn't stop writing the texts though.", "still love you", "heart"),
            ...
            ("what's the last thing they said to you. is it the last thing you'll ever hear.", "longing", "moon.stars"),
            ("finish this: what i really meant was", "unsent", "envelope"),
            ("what's the smell that drops you straight back into their bed", "regret", "arrow.uturn.backward"),
            ("how do you grieve something you're not even sure is over.", "confusion", "questionmark.circle"),
            ("what would you give to be the one they think of first again.", "still love you", "heart"),
            ("i don't want to start dating. i don't want to be alone either. where does that leave me.", "moving on", "arrow.right.circle"),
            ("what's the thing they did that you laughed off then that you want to throw across the room now", "anger", "flame"),
            ("what's the first song you could listen to again without crying.", "acceptance", "leaf"),
            ...
            ("what did you say in the last fight that you can't take back", "regret", "arrow.uturn.backward"),
            ("the mixed signals weren't confusing to them. only to me. i think.", "confusion", "questionmark.circle"),
            ...
            ("say what you couldn't say while they were still listening", "unsent", "envelope"),
            ("there's a moment you keep going back to. which one. what would you change", "regret", "arrow.uturn.backward"),
            ("am i healing or have i just gotten good at the days when nobody asks.", "confusion", "questionmark.circle"),
            ("there's a sentence you've never said to them. say it here. just once.", "still love you", "heart"),
            ("the day you stop checking if they've seen it. what does that day look like.", "moving on", "arrow.right.circle"),
            ("you're not crazy. you were never crazy. who made you doubt that and do you still let them", "anger", "flame"),
            ("what are you tired of pretending you're over.", "acceptance", "leaf"),
            ...
            ("i don't miss them at noon. at 2am i'm not so sure. which one is real.", "confusion", "questionmark.circle"),
            ("would you still pick them. knowing exactly how it ends. knowing all of it.", "still love you", "heart"),
            ("i keep waiting to feel ready. what if i just go before i'm ready.", "moving on", "arrow.right.circle"),
            ("what promise of theirs do you want to read back to them word for word", "anger", "flame"),
            ("did you rest today or just stop moving. there's a difference. be honest.", "acceptance", "leaf"),
            ...
            ("what's the gift of theirs you still keep in a drawer", "regret", "arrow.uturn.backward"),
            ("they said it wasn't about me and i still can't figure out who it was about.", "confusion", "questionmark.circle"),
            ("be honest. is there anyone you compare to them. does anyone win.", "still love you", "heart"),
            ("what would you tell the next person about you, if you weren't afraid of scaring them.", "moving on", "arrow.right.circle"),
            ("they got to leave clean and you got the wreckage. where's the fairness in that", "anger", "flame"),
            ("what small routine is keeping you upright right now.", "acceptance", "leaf"),
            ("do you wonder if they're lying awake too. or if it's just you.", "longing", "moon.stars"),
            ("finish this: i should have told you", "unsent", "envelope"),
            ("what did you stop doing for them that you wish you hadn't", "regret", "arrow.uturn.backward"),
            ...
            ("what's the comeback you thought of three days too late. say it here instead", "anger", "flame"),
            ("name a moment today you forgot to be sad. let yourself have had it.", "acceptance", "leaf"),
            ("what's the place you avoid now because you'll see them there in your head.", "longing", "moon.stars"),
            ...
            ("i keep rereading the last conversation for a clue i already know isn't there.", "confusion", "questionmark.circle"),
            ("the love didn't leave when they did. what do you do with it now.", "still love you", "heart"),
            ("you survived the version of you that didn't think you'd survive. what now.", "moving on", "arrow.right.circle"),
            ("did they make you small so they could feel big. how long did it work", "anger", "flame"),
            ("what's one thing you used to dread that felt okay today.", "acceptance", "leaf"),
            ("i found their hair on a sweater i haven't worn in months and i lost it.", "longing", "moon.stars"),
            ("the thing you almost confessed and then changed the subject. confess it now.", "unsent", "envelope"),
            ("what's the order you can't place anymore because it was theirs too", "regret", "arrow.uturn.backward"),
            ("part of me is relieved and i don't know what that says about all of it.", "confusion", "questionmark.circle"),
            ("you keep their old messages. you're not gonna delete them. why.", "still love you", "heart"),
            ("what does a tuesday look like when it isn't about them anymore.", "moving on", "arrow.right.circle"),
            ("what are you still defending them for and who are you protecting really", "anger", "flame"),
            ("you survived the day you didn't think you'd survive. how does that sit.", "acceptance", "leaf"),
            ("say the thing you wish you could tell them right now at this exact hour.", "longing", "moon.stars"),
            ("type out the last thing you wish they'd heard from you", "unsent", "envelope"),
            ("what did you almost tell them and then didn't", "regret", "arrow.uturn.backward"),
            ("you're quieter now. is that peace or did you just stop reaching for them.", "confusion", "questionmark.circle"),
            ("if you saw them tomorrow. what would your hands want to do first.", "still love you", "heart"),
            ("i don't miss them today. i miss missing them, which is somehow worse. is it.", "moving on", "arrow.right.circle"),
            ("the worst part isn't that they did it. it's that they knew exactly what it would do to you and did it anyway. didn't they", "anger", "flame"),
            ...
            ("what's the date on the calendar that still wrecks you", "regret", "arrow.uturn.backward"),
            ("i can't tell if i forgive them or if i just forgot to keep being angry.", "confusion", "questionmark.circle"),
            ...
            ("they were everything and now i can't remember why. that scares me more than missing them.", "confusion", "questionmark.circle"),
            ...
            ("finish this: if i had been braver i'd have said", "unsent", "envelope"),
            ("what's the song you put on just to feel it open back up", "regret", "arrow.uturn.backward"),
            ("do you still love them or is it just the muscle memory of having.", "confusion", "questionmark.circle"),
            ("there's a part of you that never agreed to the breakup. let it speak.", "still love you", "heart"),
            ("name the moment you realized you stopped editing texts you were never going to send.", "moving on", "arrow.right.circle"),
            ("how many of your own needs did you shrink so they wouldn't feel crowded", "anger", "flame"),
            ("what hurts a little less than it did last week. notice it out loud.", "acceptance", "leaf"),
            ("what's the inside joke nobody else will ever understand. who do you tell it to now.", "longing", "moon.stars"),
            ("write what you would text right now if you knew they'd never see it", "unsent", "envelope"),
            ...
            ("you're allowed to not be fine and still be doing this right.", "acceptance", "leaf"),
            ("i keep waiting for a text that isn't coming and i hate that i still check.", "longing", "moon.stars"),
            ("the words stuck in your throat the whole time. let them out.", "unsent", "envelope"),
            ("what's the chore you used to hate that you miss doing with them", "regret", "arrow.uturn.backward"),
            ("i feel okay and i keep waiting for the okay to turn out fake.", "confusion", "questionmark.circle"),
            ("you pretend it was just a season. but you still water it. don't you.", "still love you", "heart"),
            ("i don't want to forget them. i just want to stop being haunted. is there a difference.", "moving on", "arrow.right.circle"),
            ("what's the thing you bit back every time. let it out, no one here is grading your tone", "anger", "flame"),
            ...
            ("type the truth you hid inside i'm fine", "unsent", "envelope"),
            ("what did you assume you'd have more time for. and then you didn't", "regret", "arrow.uturn.backward"),
            ("which is worse. that they changed. or that maybe they didn't and i just stopped seeing it.", "confusion", "questionmark.circle"),
            ...
            ("i'm not waiting for them to come back. i think. ask me again tomorrow.", "confusion", "questionmark.circle"),
            ("would you wait. if they asked you to wait. how long. be honest.", "still love you", "heart"),
            ("what habit did you build around them that you're quietly letting die.", "moving on", "arrow.right.circle"),
            ("you weren't too much. you were exactly enough and they couldn't handle being seen by someone who was. say it meaner than that", "anger", "flame"),
            ...
            ("finish this: there's something i never admitted to you", "unsent", "envelope"),
            ("what do you still buy at the store out of habit for two", "regret", "arrow.uturn.backward"),
            ("the silence felt like an answer for a while. now i'm not sure it was one.", "confusion", "questionmark.circle"),
            ("the song comes on and you let it play the whole way through. why.", "still love you", "heart"),
            ("you'll have to tell someone everything again one day. who do you want them to meet.", "moving on", "arrow.right.circle"),
            ...
            ("what's the photo you can't delete but can't look at either.", "longing", "moon.stars"),
            ("say the thing you were saving for the right moment that never came", "unsent", "envelope"),
            ("what's the thing you broke that you can't fix now", "regret", "arrow.uturn.backward"),
            ...
            ("they want to be friends. what's the laugh you held back when they asked", "anger", "flame"),
            ("what's the first plan you made that didn't include them.", "acceptance", "leaf"),
            ...
            ("some nights i don't miss them at all and that absence is its own kind of strange.", "confusion", "questionmark.circle"),
            ("be honest. do you want them back. or do you want who you were with them.", "still love you", "heart"),
            ("i moved their stuff into a box today. didn't cry. didn't feel good either. what is this.", "moving on", "arrow.right.circle"),
            ("what's the favor you did at 2am that they never even thanked you for", "anger", "flame"),
            ("what did you let yourself enjoy today without guilt.", "acceptance", "leaf"),
            ("i wonder if they kept the thing i gave them. or if it's in a drawer somewhere.", "longing", "moon.stars"),
            ("write what you wish you'd said instead of okay", "unsent", "envelope"),
            ("what's the night you wish you had just stayed", "regret", "arrow.uturn.backward"),
            ...
            ("what's the time of day that hits the hardest. morning. dusk. 2am.", "longing", "moon.stars"),
            ("the sentence you couldn't finish out loud. finish it here.", "unsent", "envelope"),
            ("what did you let get cold and small instead of saying it out loud", "regret", "arrow.uturn.backward"),
            ("am i moving on or just moving. there's a difference and i lost it somewhere.", "confusion", "questionmark.circle"),
            ("you keep saying it was for the best. say what you actually feel.", "still love you", "heart"),
            ("name something you want now that you wouldn't have let yourself want with them.", "moving on", "arrow.right.circle"),
            ("did they break it slow so they could pretend it wasn't them. catch them in it", "anger", "flame"),
            ("what part of you is starting to come back. don't scare it off. just notice.", "acceptance", "leaf"),
            ("do you still wear the thing that smells like them. or did you have to stop.", "longing", "moon.stars"),
            ("type the confession you only make when it's dark", "unsent", "envelope"),
            ("what number do you still know by heart that you can't call", "regret", "arrow.uturn.backward"),
            ("i can't tell if i want them or if i just want to not be the one who lost.", "confusion", "questionmark.circle"),
            ("would you trade being right for having them. tonight. yes or no.", "still love you", "heart"),
            ("the future used to have their face in it. what's there now when you squint.", "moving on", "arrow.right.circle"),
            ...
            ("everyone keeps saying you'll understand it later. it's later. i don't.", "confusion", "questionmark.circle"),
            ("there's a name your heart still calls home. you don't have to say it. but.", "still love you", "heart"),
            ("i don't want closure. i want to wake up one day and find it already closed. can i.", "moving on", "arrow.right.circle"),
            ("they cried too. but whose tears were performance and whose were the real wound", "anger", "flame"),
            ("what are you pretending doesn't still ache on the quiet days.", "acceptance", "leaf"),
            ...
            ("what's the plan you two made that you can't unmake in your head", "regret", "arrow.uturn.backward"),
            ...
            ("finish this: i used to be theirs, and now i'm slowly becoming", "moving on", "arrow.right.circle"),
            ("how long did you confuse their carelessness for something you'd done wrong", "anger", "flame"),
            ("did you eat something real today or just whatever was closest. no judgment.", "acceptance", "leaf"),
            ("i practice what i'd say if i ran into them. i've practiced it a hundred times.", "longing", "moon.stars"),
            ("say what you wanted to whisper but kept quiet", "unsent", "envelope"),
            ("finish this: i keep thinking if i'd picked up the phone", "regret", "arrow.uturn.backward"),
            ("i went a whole day without it hurting and then i felt guilty. explain that one to me.", "confusion", "questionmark.circle"),
            ("be honest. how much of moving on is just acting until they can't tell.", "still love you", "heart"),
            ("what is the smallest sign that you're healing that you almost didn't notice.", "moving on", "arrow.right.circle"),
            ("what's the version of events they'll tell their next person about you. correct the record here", "anger", "flame"),
            ("what's one thing that felt steady when everything else didn't.", "acceptance", "leaf"),
            ("what's the food you can't order anymore because it was yours together.", "longing", "moon.stars"),
            ("type the message your hands wrote that your heart deleted", "unsent", "envelope"),
            ("what's the show you still can't watch the rest of without them", "regret", "arrow.uturn.backward"),
            ("is this acceptance or have i just made a home out of being unsure.", "confusion", "questionmark.circle"),
            ("the love you swore you killed. it's still breathing isn't it. quietly.", "still love you", "heart"),
            ("you don't have to be over it to start walking. which direction faces away from them.", "moving on", "arrow.right.circle"),
            ("you held the whole thing up alone and they called it a partnership. what's the word you actually want to use", "anger", "flame"),
            ...
            ("write the thing you wish they'd known before it was too late", "unsent", "envelope"),
            ("what did you blame on them that was really on you", "regret", "arrow.uturn.backward"),
            ("i don't know if i loved them or loved being chosen. those felt the same until they weren't.", "confusion", "questionmark.circle"),
            ("if they said i never stopped. what would you say back. don't think.", "still love you", "heart"),
            ...
            ("name a small thing you looked forward to today. it doesn't have to be big.", "acceptance", "leaf"),
            ...
            ("what's the seat at the table that's still theirs in your head", "regret", "arrow.uturn.backward"),
            ("the relationship made sense from the inside. now i can't rebuild the logic of it.", "confusion", "questionmark.circle"),
            ("would you give up the closure just to keep the hope. some of you would.", "still love you", "heart"),
            ("i practiced their name in past tense today. it didn't break me. when did that happen.", "moving on", "arrow.right.circle"),
            ("what's the kindness you showed them that they used as a weapon later", "anger", "flame"),
            ("what are you surviving right now that you won't always have to survive.", "acceptance", "leaf"),
            ...
            ("you still set a place for them somehow. in your head. don't you.", "still love you", "heart"),
            ("what would it take to believe the next chapter isn't just an apology for this one.", "moving on", "arrow.right.circle"),
            ("they're sleeping fine tonight. that should make you angrier than it makes you sad. does it", "anger", "flame"),
            ...
            ("i stopped checking their profile and i can't tell if that's strength or surrender.", "confusion", "questionmark.circle"),
            ...
            ("what's the word or phrase only they used. do you still hear it.", "longing", "moon.stars"),
            ("write what you couldn't say without breaking, so you said nothing", "unsent", "envelope"),
            ...
            ("say the thing you keep softening for everyone else. don't soften it here", "anger", "flame"),
            ...
            ("the thing you most want them to know. you're not over it. write it anyway.", "still love you", "heart"),
            ...
            ("what's the dream you keep having where they're back. how do you feel when you wake.", "longing", "moon.stars"),
