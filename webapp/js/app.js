...
const DAILY_PROMPTS = [
    ["it's 2am and you can't sleep. what are you thinking about.", "longing"],
    ...
    ["i don't want to start over with someone new and explain all my shit again. do you feel that.", "moving on"],
    ...
    ["what's the thing you can't tell anyone because they'd say you're crazy", "longing"],
    ["write the letter you'll never send. start with dear you.", "unsent"],
    ["what's something small that still ruins you. a song. a street. a food.", "regret"],
    ["do you miss them or do you miss not being alone. it's okay if you don't know.", "confusion"],
    ["say the thing you pretend you don't feel anymore", "still love you"],
    ["what would it take to feel like a beginning instead of an aftermath.", "moving on"],
    ["what's the thing you can't forgive them for", "anger"],
    ...
    ["say something you haven't said out loud to anyone. not even yourself.", "unsent"],
    ...
    ["you got out of bed today. that's not nothing. say it like it counts.", "acceptance"],
    ["what song do you skip now because it ruins you", "longing"],
    ["type out the message that's been sitting in your drafts for weeks", "unsent"],
    ["what's the most pathetic thing you've done since it ended. no judgment here.", "regret"],
    ["the thing nobody understands about what happened is", "confusion"],
    ["do you still love them. you don't have to answer that. but do you.", "still love you"],
    ["who are you when you're not orbiting them. be honest.", "moving on"],
    ["say it. the one thing you would've screamed if you weren't so busy being calm and reasonable", "anger"],
    ["what is the first thing that tasted good again. even a little.", "acceptance"],
    ["what's the thought you have every single morning before you can stop it", "longing"],
    ["write what you would've said if you'd picked up the last time they called", "unsent"],
    ["what's the last thing that made you cry about it. like actually cry.", "regret"],
    ...
    ["i don't want to be brave. i just want to wake up and not reach for my phone first.", "moving on"],
    ["what's the lie they told that still makes your face hot when you remember it", "anger"],
    ["name one small thing you did today that you didn't think you'd manage.", "acceptance"],
    ["do you think about them every day still or just most days", "longing"],
    ["the apology you never gave. write it now.", "unsent"],
    ["what's the thing you wish you'd said before they walked out the door", "regret"],
    ...
    ["you're still here. say what got you through the worst hour.", "acceptance"],
    ["finish this: i just want someone to", "longing"],
    ["finish this: i never told you that", "unsent"],
    ["there's a text you never sent. what's in it", "regret"],
    ["some days i'm fine and i can't tell if that's progress or if i just stopped feeling it.", "confusion"],
    ["you tell people you're over it. who are you actually trying to convince.", "still love you"],
    ...
    ["i keep waiting to understand what went wrong like it's a sentence i'll finish someday.", "confusion"],
    ["there's a version of you still waiting by the phone. say hi to her.", "still love you"],
    ["there was a whole life you planned around them. what gets to be yours now.", "moving on"],
    ["name the thing you forgave that you shouldn't have", "anger"],
    ["did you go outside today. even to the door. that's allowed to count.", "acceptance"],
    ...
    ["what's the apology you keep rehearsing for no one", "regret"],
    ["you're not sad today. is that healing or is that just monday.", "confusion"],
    ["if love really left. why does their name still do that to your chest.", "still love you"],
    ["i caught myself laughing today and didn't feel guilty after. is that what this is.", "moving on"],
    ["you're allowed to be furious. you don't have to be the bigger person tonight", "anger"],
    ["what felt almost normal today. don't rush past it.", "acceptance"],
    ...
    ["what would you do this week if you weren't waiting for them to come back.", "moving on"],
    ["what did they take that they didn't even want. they just didn't want you to have it", "anger"],
    ["you've been holding it together for everyone. who holds it for you.", "acceptance"],
    ...
    ["the apology you got was for the wrong thing wasn't it. what did they actually need to say", "anger"],
    ["what did you let yourself feel today instead of pushing it down.", "acceptance"],
    ["what's the smell that brings them back instantly. cologne. their pillow. rain.", "longing"],
    ["write what you wish you'd answered when they asked if you were okay", "unsent"],
    ["what's the last thing you lied to them about. and why", "regret"],
    ["i replay the part where it was still good and i can't find the exact second it wasn't.", "confusion"],
    ["you've forgiven them already haven't you. you just haven't told them.", "still love you"],
    ["what is one thing that's yours again that used to be ours.", "moving on"],
    ...
    ["there's a version of you that fought harder. what would they have done", "regret"],
    ["are you over it or did you just run out of ways to say you're not.", "confusion"],
    ["if they called and only said your name. what would you do.", "still love you"],
    ["i don't want a clean slate. i just want to stop flinching at their name.", "moving on"],
    ["what's the sentence of theirs you replay just to stay angry enough not to text back", "anger"],
    ["what part of your day didn't hurt. start there.", "acceptance"],
    ["what part of their body do you miss the most. not the obvious one.", "longing"],
    ["type the message you'll never have the nerve to send", "unsent"],
    ["what do you reread late at night that you know you shouldn't", "regret"],
    ...
    ["what did you want to say at the door but didn't", "unsent"],
    ["what did you take for granted right up until it was gone", "regret"],
    ["i'm not crying anymore and i don't know if that's relief or something worse.", "confusion"],
    ...
    ["what are you still pretending you don't miss.", "acceptance"],
    ["do you still know their number by heart. do you ever almost dial it.", "longing"],
    ["write the version of i love you you couldn't say back then", "unsent"],
    ["finish this: if i'd only", "regret"],
    ...
    ["what would you say to their face if you knew they'd actually have to sit there and hear it", "anger"],
    ["did you laugh today. even once. it doesn't mean you're okay but it's something.", "acceptance"],
    ...
    ["what's the thing they asked you for that you didn't give them", "regret"],
    ["there's a version of me from before that i can't get back to. do you ever look for yours.", "confusion"],
    ["if they were happy without you. could you actually be glad. could you.", "still love you"],
    ["you're allowed to want a future that doesn't include them. say it out loud.", "moving on"],
    ["they're out there telling their side. what's the part they're leaving out", "anger"],
    ["what would it look like to be gentle with yourself for the next ten minutes.", "acceptance"],
    ["i keep their side of the bed cold and untouched like they're coming back.", "longing"],
    ["type out what you rehearsed in the shower but never said", "unsent"],
    ["what street do you go out of your way to avoid now", "regret"],
    ["i thought i knew them. now i don't know which year was the lie.", "confusion"],
    ["you stopped texting them. you didn't stop writing the texts though.", "still love you"],
    ...
    ["what's the last thing they said to you. is it the last thing you'll ever hear.", "longing"],
    ["finish this: what i really meant was", "unsent"],
    ["what's the smell that drops you straight back into their bed", "regret"],
    ["how do you grieve something you're not even sure is over.", "confusion"],
    ["what would you give to be the one they think of first again.", "still love you"],
    ["i don't want to start dating. i don't want to be alone either. where does that leave me.", "moving on"],
    ["what's the thing they did that you laughed off then that you want to throw across the room now", "anger"],
    ["what's the first song you could listen to again without crying.", "acceptance"],
    ...
    ["what did you say in the last fight that you can't take back", "regret"],
    ["the mixed signals weren't confusing to them. only to me. i think.", "confusion"],
    ...
    ["say what you couldn't say while they were still listening", "unsent"],
    ["there's a moment you keep going back to. which one. what would you change", "regret"],
    ["am i healing or have i just gotten good at the days when nobody asks.", "confusion"],
    ["there's a sentence you've never said to them. say it here. just once.", "still love you"],
    ["the day you stop checking if they've seen it. what does that day look like.", "moving on"],
    ["you're not crazy. you were never crazy. who made you doubt that and do you still let them", "anger"],
    ["what are you tired of pretending you're over.", "acceptance"],
    ...
    ["i don't miss them at noon. at 2am i'm not so sure. which one is real.", "confusion"],
    ["would you still pick them. knowing exactly how it ends. knowing all of it.", "still love you"],
    ["i keep waiting to feel ready. what if i just go before i'm ready.", "moving on"],
    ["what promise of theirs do you want to read back to them word for word", "anger"],
    ["did you rest today or just stop moving. there's a difference. be honest.", "acceptance"],
    ...
    ["what's the gift of theirs you still keep in a drawer", "regret"],
    ["they said it wasn't about me and i still can't figure out who it was about.", "confusion"],
    ["be honest. is there anyone you compare to them. does anyone win.", "still love you"],
    ["what would you tell the next person about you, if you weren't afraid of scaring them.", "moving on"],
    ["they got to leave clean and you got the wreckage. where's the fairness in that", "anger"],
    ["what small routine is keeping you upright right now.", "acceptance"],
    ["do you wonder if they're lying awake too. or if it's just you.", "longing"],
    ["finish this: i should have told you", "unsent"],
    ["what did you stop doing for them that you wish you hadn't", "regret"],
    ...
    ["what's the comeback you thought of three days too late. say it here instead", "anger"],
    ["name a moment today you forgot to be sad. let yourself have had it.", "acceptance"],
    ["what's the place you avoid now because you'll see them there in your head.", "longing"],
    ["write what you wanted them to know before they walked away", "unsent"],
    ["finish this: i was too proud to", "regret"],
    ["i keep rereading the last conversation for a clue i already know isn't there.", "confusion"],
    ["the love didn't leave when they did. what do you do with it now.", "still love you"],
    ["you survived the version of you that didn't think you'd survive. what now.", "moving on"],
    ["did they make you small so they could feel big. how long did it work", "anger"],
    ["what's one thing you used to dread that felt okay today.", "acceptance"],
    ["i found their hair on a sweater i haven't worn in months and i lost it.", "longing"],
    ["the thing you almost confessed and then changed the subject. confess it now.", "unsent"],
    ["what's the order you can't place anymore because it was theirs too", "regret"],
    ["part of me is relieved and i don't know what that says about all of it.", "confusion"],
    ["you keep their old messages. you're not gonna delete them. why.", "still love you"],
    ["what does a tuesday look like when it isn't about them anymore.", "moving on"],
    ["what are you still defending them for and who are you protecting really", "anger"],
    ["you survived the day you didn't think you'd survive. how does that sit.", "acceptance"],
    ["say the thing you wish you could tell them right now at this exact hour.", "longing"],
    ["type out the last thing you wish they'd heard from you", "unsent"],
    ["what did you almost tell them and then didn't", "regret"],
    ["you're quieter now. is that peace or did you just stop reaching for them.", "confusion"],
    ["if you saw them tomorrow. what would your hands want to do first.", "still love you"],
    ["i don't miss them today. i miss missing them, which is somehow worse. is it.", "moving on"],
    ["the worst part isn't that they did it. it's that they knew exactly what it would do to you and did it anyway. didn't they", "anger"],
    ...
    ["what's the date on the calendar that still wrecks you", "regret"],
    ["i can't tell if i forgive them or if i just forgot to keep being angry.", "confusion"],
    ...
    ["they were everything and now i can't remember why. that scares me more than missing them.", "confusion"],
    ...
    ["finish this: if i had been braver i'd have said", "unsent"],
    ["what's the song you put on just to feel it open back up", "regret"],
    ["do you still love them or is it just the muscle memory of having.", "confusion"],
    ["there's a part of you that never agreed to the breakup. let it speak.", "still love you"],
    ["name the moment you realized you stopped editing texts you were never going to send.", "moving on"],
    ["how many of your own needs did you shrink so they wouldn't feel crowded", "anger"],
    ["what hurts a little less than it did last week. notice it out loud.", "acceptance"],
    ["what's the inside joke nobody else will ever understand. who do you tell it to now.", "longing"],
    ["write what you would text right now if you knew they'd never see it", "unsent"],
    ...
    ["you're allowed to not be fine and still be doing this right.", "acceptance"],
    ["i keep waiting for a text that isn't coming and i hate that i still check.", "longing"],
    ["the words stuck in your throat the whole time. let them out.", "unsent"],
    ["what's the chore you used to hate that you miss doing with them", "regret"],
    ["i feel okay and i keep waiting for the okay to turn out fake.", "confusion"],
    ["you pretend it was just a season. but you still water it. don't you.", "still love you"],
    ["i don't want to forget them. i just want to stop being haunted. is there a difference.", "moving on"],
    ["what's the thing you bit back every time. let it out, no one here is grading your tone", "anger"],
    ...
    ["type the truth you hid inside i'm fine", "unsent"],
    ["what did you assume you'd have more time for. and then you didn't", "regret"],
    ["which is worse. that they changed. or that maybe they didn't and i just stopped seeing it.", "confusion"],
    ...
    ["i'm not waiting for them to come back. i think. ask me again tomorrow.", "confusion"],
    ["would you wait. if they asked you to wait. how long. be honest.", "still love you"],
    ["what habit did you build around them that you're quietly letting die.", "moving on"],
    ["you weren't too much. you were exactly enough and they couldn't handle being seen by someone who was. say it meaner than that", "anger"],
    ...
    ["finish this: there's something i never admitted to you", "unsent"],
    ["what do you still buy at the store out of habit for two", "regret"],
    ["the silence felt like an answer for a while. now i'm not sure it was one.", "confusion"],
    ["the song comes on and you let it play the whole way through. why.", "still love you"],
    ["you'll have to tell someone everything again one day. who do you want them to meet.", "moving on"],
    ...
    ["what's the photo you can't delete but can't look at either.", "longing"],
    ["say the thing you were saving for the right moment that never came", "unsent"],
    ["what's the thing you broke that you can't fix now", "regret"],
    ...
    ["they want to be friends. what's the laugh you held back when they asked", "anger"],
    ["what's the first plan you made that didn't include them.", "acceptance"],
    ...
    ["some nights i don't miss them at all and that absence is its own kind of strange.", "confusion"],
    ["be honest. do you want them back. or do you want who you were with them.", "still love you"],
    ["i moved their stuff into a box today. didn't cry. didn't feel good either. what is this.", "moving on"],
    ["what's the favor you did at 2am that they never even thanked you for", "anger"],
    ["what did you let yourself enjoy today without guilt.", "acceptance"],
    ["i wonder if they kept the thing i gave them. or if it's in a drawer somewhere.", "longing"],
    ["write what you wish you'd said instead of okay", "unsent"],
    ["what's the night you wish you had just stayed", "regret"],
    ...
    ["what's the time of day that hits the hardest. morning. dusk. 2am.", "longing"],
    ["the sentence you couldn't finish out loud. finish it here.", "unsent"],
    ["what did you let get cold and small instead of saying it out loud", "regret"],
    ["am i moving on or just moving. there's a difference and i lost it somewhere.", "confusion"],
    ["you keep saying it was for the best. say what you actually feel.", "still love you"],
    ["name something you want now that you wouldn't have let yourself want with them.", "moving on"],
    ["did they break it slow so they could pretend it wasn't them. catch them in it", "anger"],
    ["what part of you is starting to come back. don't scare it off. just notice.", "acceptance"],
    ["do you still wear the thing that smells like them. or did you have to stop.", "longing"],
    ["type the confession you only make when it's dark", "unsent"],
    ["what number do you still know by heart that you can't call", "regret"],
    ["i can't tell if i want them or if i just want to not be the one who lost.", "confusion"],
    ["would you trade being right for having them. tonight. yes or no.", "still love you"],
    ["the future used to have their face in it. what's there now when you squint.", "moving on"],
    ...
    ["everyone keeps saying you'll understand it later. it's later. i don't.", "confusion"],
    ["there's a name your heart still calls home. you don't have to say it. but.", "still love you"],
    ["i don't want closure. i want to wake up one day and find it already closed. can i.", "moving on"],
    ["they cried too. but whose tears were performance and whose were the real wound", "anger"],
    ["what are you pretending doesn't still ache on the quiet days.", "acceptance"],
    ["what season reminds you of them and is it coming back around.", "longing"],
    ["finish this: i never got to tell you that you", "unsent"],
    ["what's the plan you two made that you can't unmake in your head", "regret"],
    ...
    ["finish this: i used to be theirs, and now i'm slowly becoming", "moving on"],
    ["how long did you confuse their carelessness for something you'd done wrong", "anger"],
    ["did you eat something real today or just whatever was closest. no judgment.", "acceptance"],
    ["i practice what i'd say if i ran into them. i've practiced it a hundred times.", "longing"],
    ["say what you wanted to whisper but kept quiet", "unsent"],
    ["finish this: i keep thinking if i'd picked up the phone", "regret"],
    ["i went a whole day without it hurting and then i felt guilty. explain that one to me.", "confusion"],
    ["be honest. how much of moving on is just acting until they can't tell.", "still love you"],
    ["what is the smallest sign that you're healing that you almost didn't notice.", "moving on"],
    ["what's the version of events they'll tell their next person about you. correct the record here", "anger"],
    ["what's one thing that felt steady when everything else didn't.", "acceptance"],
    ["what's the food you can't order anymore because it was yours together.", "longing"],
    ["type the message your hands wrote that your heart deleted", "unsent"],
    ["what's the show you still can't watch the rest of without them", "regret"],
    ["is this acceptance or have i just made a home out of being unsure.", "confusion"],
    ["the love you swore you killed. it's still breathing isn't it. quietly.", "still love you"],
    ["you don't have to be over it to start walking. which direction faces away from them.", "moving on"],
    ["you held the whole thing up alone and they called it a partnership. what's the word you actually want to use", "anger"],
    ...
    ["write the thing you wish they'd known before it was too late", "unsent"],
    ["what did you blame on them that was really on you", "regret"],
    ["i don't know if i loved them or loved being chosen. those felt the same until they weren't.", "confusion"],
    ["if they said i never stopped. what would you say back. don't think.", "still love you"],
    ...
    ["name a small thing you looked forward to today. it doesn't have to be big.", "acceptance"],
    ...
    ["what's the seat at the table that's still theirs in your head", "regret"],
    ["the relationship made sense from the inside. now i can't rebuild the logic of it.", "confusion"],
    ["would you give up the closure just to keep the hope. some of you would.", "still love you"],
    ["i practiced their name in past tense today. it didn't break me. when did that happen.", "moving on"],
    ["what's the kindness you showed them that they used as a weapon later", "anger"],
    ["what are you surviving right now that you won't always have to survive.", "acceptance"],
    ...
    ["you still set a place for them somehow. in your head. don't you.", "still love you"],
    ["what would it take to believe the next chapter isn't just an apology for this one.", "moving on"],
    ["they're sleeping fine tonight. that should make you angrier than it makes you sad. does it", "anger"],
    ...
    ["i stopped checking their profile and i can't tell if that's strength or surrender.", "confusion"],
    ...
    ["what's the word or phrase only they used. do you still hear it.", "longing"],
    ["write what you couldn't say without breaking, so you said nothing", "unsent"],
    ...
    ["say the thing you keep softening for everyone else. don't soften it here", "anger"],
    ...
    ["the thing you most want them to know. you're not over it. write it anyway.", "still love you"],
    ...
    ["what's the dream you keep having where they're back. how do you feel when you wake.", "longing"],
